...
class Department(models.Model):
    ...
    gm_id = fields.Many2one('hr.employee', string='General Manager', compute="_compute_gm_id", store=True, readonly=False)
    ...
    def _compute_gm_id(self):
        for dept in self.filtered('parent_id.gm_id'):
            dept.gm_id = dept.parent_id.gm_id
